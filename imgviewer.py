...
class Button():
    ...
    def draw_button(self):
        timer_off=lambda ct, ti, deb : ct-ti > deb*10**9
...
def main():
    ...
    while running:
        ...
        if args.visible:
            ...
            while x < width:
                x += 100
                pygame.draw.line(line_surf, '#ffffffdd',(x,0), (x,height), 1)
...
if __name__ == '__main__':
    ...
    if args.resolution is None:
        ...
        try:
            screen = pygame.display.set_mode((int(args.resolution[0]),int(args.resolution[1])))
        except IndexError:
